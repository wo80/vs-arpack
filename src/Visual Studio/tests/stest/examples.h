...
int sndrv6();
int sndrv6_av_(int* n, float* v, float* w);
int sndrv6_mv_(int* n, float* v, float* w);

int snsimp();
int snsimp_av_(int* nx, float* v, float* w);
int snsimp_tv_(int* nx, float* x, float* y);

int ssdrv1();
int ssdrv1_av_(int* nx, float* v, float* w);

int ssdrv2();
int ssdrv2_av_(int* nx, float* v, float* w);

int ssdrv3();
int ssdrv3_av_(int* nx, float* v, float* w);
int ssdrv3_mv_(int* n, float* v, float* w);

int ssdrv4();
int ssdrv4_av_(int* nx, float* v, float* w);
int ssdrv4_mv_(int* n, float* v, float* w);

int ssdrv5();
int ssdrv5_av_(int* nx, float* v, float* w);
int ssdrv5_mv_(int* n, float* v, float* w);

int ssdrv6();
int ssdrv6_av_(int* nx, float* v, float* w);
int ssdrv6_mv_(int* n, float* v, float* w);
