...
int dndrv4();
int dndrv4_av_(int* n, double* v, double* w);
int dndrv4_mv_(int* n, double* v, double* w);

int dndrv5();
int dndrv5_av_(int* n, double* v, double* w);
int dndrv5_mv_(int* n, double* v, double* w);
...
int dnsimp();
int dnsimp_av_(int* nx, double* v, double* w);
int dnsimp_tv_(int* nx, double* x, double* y);

int dsdrv1();
int dsdrv1_av_(int* nx, double* v, double* w);

int dsdrv2();
int dsdrv2_av_(int* nx, double* v, double* w);

int dsdrv3();
int dsdrv3_av_(int* nx, double* v, double* w);
int dsdrv3_mv_(int* n, double* v, double* w);

int dsdrv4();
int dsdrv4_av_(int* nx, double* v, double* w);
int dsdrv4_mv_(int* n, double* v, double* w);

int dsdrv5();
int dsdrv5_av_(int* nx, double* v, double* w);
int dsdrv5_mv_(int* n, double* v, double* w);

int dsdrv6();
int dsdrv6_av_(int* nx, double* v, double* w);
