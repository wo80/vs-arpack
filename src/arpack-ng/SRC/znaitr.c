 ...
 * \EndLib
 */
int znaitr_(int *ido, const char *bmat, int *n, int *k,int *np, int *nb,
...
L100:
    ...
    if (j > *k + *np)
    {
        ...
        *ido = 99;
        ...
        {
            i__1 = *k + *np;
            zmout_(1, 1, &h[h_offset], *ldh, debug_1.ndigit, "_naitr: Final upper Hessenberg matrix H of order K+NP");
        }
#endif
