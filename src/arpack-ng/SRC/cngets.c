 ...
 * \EndLib
 */
int cngets_(int *ishift, const char *which, int *kev, int *np, a_fcomplex *ritz, a_fcomplex *bounds)
{
    ...
    if (msglvl > 0)
    {
        ...
        cvout_(1, ritz, debug_1.ndigit, "_ngets: Eigenvalues of current H matrix ");
        cvout_(1, bounds, debug_1.ndigit, "_ngets: Ritz estimates of the current KEV+NP Ritz values");
    }
#endif
