/* D:\Projekte\ARPACK\arpack-ng\SRC\snaitr.f -- translated by f2c (version 20100827). */
...
L90:
	...
	if (msglvl > 2) {
	    xtemp[0] = *rnorm;
	    xtemp[1] = rnorm1;
	    svout_(&debug_1.logfil, &c__2, xtemp, &debug_1.ndigit, "_naitr: iterative refinement ; rnorm and rnorm1 are");
	}
    }
