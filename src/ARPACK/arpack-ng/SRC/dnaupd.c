...
/* Computing 2nd power */
	...
	*info = 3;
    ...
    if (msglvl > 0) {
        ...
        printf(" Total time in Arnoldi update routine       =  %12f", timing_1.tnaupd);
        printf(" Total time in naup2 routine                =  %12f", timing_1.tnaup2);
        printf(" Total time in basic Arnoldi iteration loop =  %12f", timing_1.tnaitr);
        ...
        printf(" Total time in Hessenberg eig. subproblem   =  %12f", timing_1.tneigh);
        printf(" Total time in getting the shifts           =  %12f", timing_1.tngets);
        printf(" Total time in applying the shifts          =  %12f", timing_1.tnapps);
        printf(" Total time in convergence testing          =  %12f", timing_1.tnconv);
